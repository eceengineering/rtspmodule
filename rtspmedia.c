...
static void gst_rtsp_media_factory_custom_get_property (GObject * object, 
			guint propid, GValue * value, GParamSpec * pspec);
static void gst_rtsp_media_factory_custom_set_property (GObject * object, 
			guint propid, const GValue * value, GParamSpec * pspec);
static void gst_rtsp_media_factory_custom_finalize (GObject * obj);
static GstElement * custom_get_element (GstRTSPMediaFactory * factory, const GstRTSPUrl * url);

G_DEFINE_TYPE (GstRTSPMediaFactoryCustom, gst_rtsp_media_factory_custom, 
			GST_TYPE_RTSP_MEDIA_FACTORY /*parent class*/);

static void gst_rtsp_media_factory_custom_class_init (GstRTSPMediaFactoryCustomClass * klass)
{
...
static void gst_rtsp_media_factory_custom_init (GstRTSPMediaFactoryCustom * factory)
{
  	factory->bin = NULL;
}
 ...
 * etc.. Each of the payloaders will result in a stream.
 */
void gst_rtsp_media_factory_custom_set_bin (GstRTSPMediaFactoryCustom * factory, GstElement * bin)
{
